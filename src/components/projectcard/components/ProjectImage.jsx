export const ProjectImage = ({ project, isClosed, isAuthenticated, onRegister }) => {
  const getSDGIcon = () => {
    if (project.sdgs && project.sdgs.length > 0) {
      const sdgCode = project.sdgs[0].code;
  ...
  const imageUrl = project.event_photo || project.image || "https://via.placeholder.com/400x300";
