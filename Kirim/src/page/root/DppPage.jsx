...
import Dpp from "../../layouts/about/Dpp";
  ...
  return (
    <div className="inner_body">
      <HelmetLayout
        ...
        pageLink="/dpp"
        keywords="indonesian future leaders, ifl malang, ifl chapter malang, ifl, tentang kami, about, dpp, departement program project"
      />
      <Navbar />
      <Dpp />
      <Footer />
